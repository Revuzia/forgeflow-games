/**
 * ForgeFlow Games — BARE Engine Harness for SIMULATION games
 *
 ...
 *
 * Anything else (simulation tick loop, day/night cycle, build palette,
 * resource economy, NPC AI, victory conditions, etc.) belongs in
 * patches — written by Claude from the design that the research phase
 * produced. The template should never assume what the simulation IS.
 */
