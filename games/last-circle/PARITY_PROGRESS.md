...
- [x] B4 Street furniture + hero landmarks (?v=30) — streetFurniture(): lamp posts, market stalls, benches, hydrants along town streets (all cosmetic). Landmarks: isla lighthouse, ashgrid water tower, deepwood chapel steeple. Verified live: all colours build, no exceptions.
