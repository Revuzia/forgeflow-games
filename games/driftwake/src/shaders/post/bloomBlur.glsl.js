 ...
 *
 * Weights [1,2,1; 2,4,2; 1,2,1] / 16, spread over twice a source texel — this is
 * the level that has to read as haze in the air rather than as a ring.
 */
...
/// The previous bloom level (sixteenth resolution, same size as this target).
