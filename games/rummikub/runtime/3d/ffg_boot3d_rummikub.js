/**
 * FFG runtime — 3d/ffg_boot3d_rummikub.js  (ES module entry for Rummikub)
 * Imports the shared 3D kernel + shell + the rummikub renderer, resolves the
...
await import("./ffg_rummikub3d.js" + V);    // registers genre "rummikub3d"
...
try {
  ...
  console.error("[FFG3D] rummikub boot failed:", e);
}
