...
import { createGame, legalActions, applyAction, cloneState } from '../sim/engine.js?v=23';
import { cardById, REALMS } from '../sim/cards.js?v=23';
import { chooseAction } from '../sim/ai.js?v=23';
