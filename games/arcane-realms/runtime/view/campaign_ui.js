...
import { CHAPTERS, CARDBACK_INFO, PACK_COST } from '../campaign/campaign_data.js?v=19';
import { battleState, campaignSummary, achievementList, buyPack } from '../campaign/progression.js?v=19';
import { REALMS, cardById } from '../sim/cards.js?v=19';
import { drawCard } from './cardtex.js?v=19';
