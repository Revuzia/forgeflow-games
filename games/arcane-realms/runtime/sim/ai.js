...
import { cardById } from './cards.js?v=10';
import { legalActions, applyAction, cloneState, aiView, effAtk, hasKw, opponentOf } from './engine.js?v=10';
import { rngNext } from './rng.js?v=10';
