...
import { cardById } from './cards.js?v=5';
import { legalActions, applyAction, cloneState, aiView, effAtk, hasKw, opponentOf } from './engine.js?v=5';
import { rngNext } from './rng.js?v=5';
