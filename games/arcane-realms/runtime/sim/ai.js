...
import { cardById } from './cards.js?v=8';
import { legalActions, applyAction, cloneState, aiView, effAtk, hasKw, opponentOf } from './engine.js?v=8';
import { rngNext } from './rng.js?v=8';
