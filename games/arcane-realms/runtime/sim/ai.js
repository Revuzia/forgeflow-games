...
import { cardById } from './cards.js?v=4';
import { legalActions, applyAction, cloneState, aiView, effAtk, hasKw, opponentOf } from './engine.js?v=4';
import { rngNext } from './rng.js?v=4';
