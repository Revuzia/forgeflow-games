...
import { cardById } from './cards.js?v=18';
import { legalActions, applyAction, cloneState, aiView, effAtk, hasKw, opponentOf } from './engine.js?v=18';
import { rngNext } from './rng.js?v=18';
