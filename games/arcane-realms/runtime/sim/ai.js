...
import { cardById } from './cards.js?v=17';
import { legalActions, applyAction, cloneState, aiView, effAtk, hasKw, opponentOf } from './engine.js?v=17';
import { rngNext } from './rng.js?v=17';
