 ...
 *
 *  1. PROCEDURAL, LIKE THE REST OF THE BUILD. The sky is an atmosphere integral
 *     and the figure is lofted from a table of numbers; the audio holds the same
 *     line. There is no .wav and no .mp3 anywhere here — every sound is filtered
 *     noise or an oscillator through an envelope. The one "sample" is a noise
 *     buffer this file generates from a seeded LCG at unlock time.
 *
