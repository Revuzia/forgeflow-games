...
export const TOWERS = {
  ballista: {
    ...
    cost: 110, upCost: [120, 185], placement: 'ground',
    range: [7.4, 8.0, 8.8],
    rate: [0.8, 0.95, 1.1],
    dmg: [22, 34, 52],
  ...
  spire: {
    ...
    cost: 240, upCost: [265, 405], placement: 'ground',
    range: [7.6, 8.2, 9.0],
    rate: [0.85, 0.95, 1.05],
    dmg: [16, 22, 28],
  ...
  cauldron: {
    ...
    cost: 200, upCost: [220, 340], placement: 'ground',
    range: [6.2, 6.8, 7.4],
    rate: [0.4, 0.46, 0.52],
  ...
  thorn: {
    ...
    cost: 90, upCost: [100, 150], placement: 'road',
  ...
  crossbow: {
    ...
    cost: 170, upCost: [190, 290], placement: 'ground',
  ...
  beacon: {
    ...
    cost: 220, upCost: [245, 375], placement: 'ground',
    range: [4.2, 4.8, 5.4],
    rate: [0, 0, 0],
    auraDps: [9, 14, 21],
  ...
  rune: {
    ...
    cost: 80, upCost: [90, 135], placement: 'road',
  ...
  storm: {
    ...
    cost: 260, upCost: [285, 440], placement: 'ground',
    range: [7.2, 7.8, 8.6],
    rate: [0.7, 0.8, 0.9],
    dmg: [30, 46, 68],
