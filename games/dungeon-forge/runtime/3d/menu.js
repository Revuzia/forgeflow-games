...
export class Menu {
  ...
  howTo() {
    this.g.hud.modal(`<h3>How to play</h3><div class="df-lb" style="max-width:440px">
      <b>⚒ Builder:</b> paint floor tiles (drag), raise <b>🧱 walls</b> on the grid lines (drop a 🚪 door right on a wall), then place chests, keys, enemies, traps, NPCs, lights and decorations. Select an edge door to toggle its <b>🔒 lock</b> — locked doors need a 🗝️ key, so place one on the floor, in a chest, or on an enemy. <b>Stairs</b> go both ways: Up grows a floor above, Down digs a sublevel below (5 floors max), and every landing is marked with a glowing ring. The ✔ chip tells you live whether your dungeon is solvable.<br><br>
      <b>▶ Escape:</b> WASD + mouse. <b>LMB</b> combo attack (chain 1→2→3!) · <b>RMB/F</b> class ability · <b>R</b> frost (Sorceress) · <b>Space</b> jump (hop over spikes &amp; pits!) · <b>E</b> interact / <b>open the glowing 💰 chest</b> · <b>Q</b> potion · <b>Shift</b> sprint · <b>V</b> first/third person · <b>Tab</b> target. Walk onto stairs to change floors. Find keys, open the way, survive the guardians, reach the 🌀 portal. Fastest time wins the leaderboard.<br><br>
