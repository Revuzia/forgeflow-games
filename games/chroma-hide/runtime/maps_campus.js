...
const PAL = {
  ...
  recep: [
    ...
    { model: "tree-small.glb", w: 0.9, d: 0.9, h: 1.6, colors: [0x2f7d3a, 0x3f6e46, 0x4a7c3f], rough: 0.9, metal: 0 },
    { w: 1.6, d: 1.0, h: 0.45, colors: [0x7d8899, 0xa8845c], rough: 0.5, metal: 0.1 },
    { model: "kitchenCabinet.glb", w: 0.9, d: 0.9, h: 1.6, colors: [0xc9b98a, 0x566173], rough: 0.45, metal: 0.4 },
  ...
  bullpen: [
    ...
    { model: "kitchenCabinet.glb", w: 0.9, d: 0.9, h: 1.6, colors: [0xc9b98a, 0x5a6473], rough: 0.45, metal: 0.5 },
    { w: 0.22, d: 2.0, h: 1.4, colors: [0x7d8899, 0x8a94a6], rough: 0.8, metal: 0, rots: [0, 1.57] },
  ],
  offices: [
    ...
    { model: "kitchenCabinet.glb", w: 0.9, d: 0.9, h: 1.6, colors: [0xc9b98a, 0x566173], rough: 0.45, metal: 0.5 },
  ],
  brk: [
    ...
    { model: "kitchenCabinet.glb", w: 0.9, d: 0.9, h: 1.6, colors: [0x566173, 0xc9b98a], rough: 0.45, metal: 0.4 },
  ...
  lot: [
    ...
    { model: "dumpster-quaternius.glb", w: 1.2, d: 1.2, h: 1.5, colors: [0x2f6a3a, 0x3a5a8a], rough: 0.6, metal: 0.5 },
  ...
  breez: [
    { model: "tree-small.glb", w: 0.9, d: 0.9, h: 1.6, colors: [0x2f7d3a, 0x3f8d4a], rough: 0.9, metal: 0 },
  ...
  alley: [
    ...
    { model: "dumpster-quaternius.glb", w: 1.2, d: 1.2, h: 1.5, colors: [0x3a6a3a, 0x5a5a3a], rough: 0.6, metal: 0.5 },
  ],
  // street block
  grocer: [
  ...
  cafe: [
    ...
    { model: "kitchenCabinet.glb", w: 0.9, d: 0.9, h: 1.6, colors: [0xe8e4dc, 0x566173], rough: 0.45, metal: 0.3 },
  ...
  hardware: [
    ...
    { w: 1.2, d: 0.8, h: 1.2, colors: [0xc23020, 0xd0a020], rough: 0.5, metal: 0.3 },
  ...
  street: [
    ...
    { model: "tree-small.glb", w: 0.9, d: 0.9, h: 1.6, colors: [0x4f8a3f, 0x6a9a3a], rough: 0.9, metal: 0 },
    { model: "barrier-traffic-quaternius.glb", w: 1.8, d: 0.5, h: 1.0, colors: [0xd0a020, 0xd06020], rough: 0.7, metal: 0.1, rots: [0, 1.57] },
  ],
  yard: [
    ...
    { model: "dumpster-quaternius.glb", w: 1.2, d: 1.2, h: 1.5, colors: [0x2f6a3a, 0x5a5a3a], rough: 0.6, metal: 0.5 },
  ...
  stock: [
    ...
    { model: "kitchenCabinet.glb", w: 0.9, d: 0.9, h: 1.6, colors: [0x7a828a, 0x8a6a44], rough: 0.5, metal: 0.4 },
  ],
  garden: [
    { model: "tree-small.glb", w: 0.9, d: 0.9, h: 1.6, colors: [0x3b7a3b, 0x4f8a3f, 0x2f7d3a], rough: 0.9, metal: 0 },
    ...
    buildings: [
      {
        ...
        rooms: [
          { id: "reception", name: "Reception", x: -16, z: 2, w: 28, d: 8, floor: 0x8791a1, scatter: { palette: PAL.recep, count: 16 } },
          { id: "bullpen", name: "Bullpen", x: -16, z: -6, w: 28, d: 8, floor: 0x5b6470, scatter: { palette: PAL.bullpen, count: 18 } },
          { id: "offices", name: "Offices", x: -16, z: -14, w: 28, d: 8, floor: 0x6a7280, scatter: { palette: PAL.offices, count: 16 } },
        ],
      },
      {
        ...
        rooms: [
          { id: "breakroom", name: "Break Room", x: 16, z: 2, w: 28, d: 8, floor: 0x9c8f79, scatter: { palette: PAL.brk, count: 15 } },
          { id: "copyit", name: "Copy / IT", x: 16, z: -6, w: 28, d: 8, floor: 0x5f6a78, scatter: { palette: PAL.offices, count: 16 } },
          { id: "annexconf", name: "Conference", x: 16, z: -14, w: 28, d: 8, floor: 0x6a7280, scatter: { palette: PAL.brk, count: 12 } },
        ],
      },
    ],
    zones: [
      { id: "lot", name: "Parking Lot", x: 0, z: 17, w: 64, d: 18, floor: 0x55555a, scatter: { palette: PAL.lot, count: 24, margin: 2.5 } },
      { id: "breezeway", name: "Breezeway", x: 0, z: -5, w: 4, d: 26, floor: 0x606068 },
      { id: "alley", name: "Rear Alley", x: 0, z: -22, w: 64, d: 8, floor: 0x3d4048, scatter: { palette: PAL.alley, count: 14, margin: 2 } },
    ],
    ...
    buildings: [
      {
        ...
        rooms: [{ id: "grocer", name: "Grocer", x: -20, z: -16, w: 12, d: 16, floor: 0x8f897a, scatter: { palette: PAL.grocer, count: 12 } }],
      },
      {
        id: "C", name: "Cafe", x: -20, z: 0, w: 12, d: 14, floor: 0x9c8f79,
        doors: [{ side: "E", at: 0, width: 3.2 }, { side: "W", at: 0, width: 2.6 }],
        rooms: [{ id: "cafe", name: "Cafe", x: -20, z: 0, w: 12, d: 14, floor: 0x9c8f79, scatter: { palette: PAL.cafe, count: 11 } }],
      },
      {
        id: "H", name: "Hardware", x: -20, z: 16, w: 12, d: 14, floor: 0x6f6a62,
        doors: [{ side: "E", at: 0, width: 3.2 }, { side: "W", at: 0, width: 2.6 }],
        rooms: [{ id: "hardware", name: "Hardware", x: -20, z: 16, w: 12, d: 14, floor: 0x6f6a62, scatter: { palette: PAL.hardware, count: 12 } }],
      },
    ],
    zones: [
      { id: "alley", name: "Service Alley", x: -29, z: 0, w: 6, d: 52, floor: 0x3a3844 },
      { id: "mainst", name: "Main Street", x: -3, z: 0, w: 22, d: 52, floor: 0x50505a, scatter: { palette: PAL.street, count: 20, margin: 2.4 } },
      { id: "yard", name: "Loading Yard", x: 20, z: 0, w: 24, d: 52, floor: 0x5a5a62, scatter: { palette: PAL.yard, count: 24, margin: 2.6 } },
    ],
    ...
    buildings: [
      {
        ...
        rooms: [
          { id: "vestibule", name: "Vestibule", x: -10, z: 7, w: 42, d: 6, floor: 0x8a8375, scatter: { palette: PAL.produce, count: 8 } },
          { id: "aisles", name: "Aisles", x: -21, z: -4, w: 20, d: 16, floor: 0x8f8a7c, scatter: { palette: PAL.aisles, count: 11 } },
          { id: "produce", name: "Produce & Deli", x: 1, z: -4, w: 20, d: 16, floor: 0x6f8a5c, scatter: { palette: PAL.produce, count: 12 } },
          { id: "stockroom", name: "Stockroom", x: -10, z: -15, w: 42, d: 6, floor: 0x55575a, scatter: { palette: PAL.stock, count: 10 } },
        ],
      },
    ],
    zones: [
      { id: "parking", name: "Parking", x: -11, z: 18, w: 42, d: 16, floor: 0x55555a, scatter: { palette: PAL.lot, count: 20, margin: 2.6 } },
      { id: "dock", name: "Loading Yard", x: 21, z: 4, w: 21, d: 44, floor: 0x5a5a62, scatter: { palette: PAL.yard, count: 18, margin: 2.6 } },
      { id: "gardenctr", name: "Garden Centre", x: 21, z: -22, w: 21, d: 8, floor: 0x3f5a3a, scatter: { palette: PAL.garden, count: 8, margin: 2 } },
    ],
