...
export const CAMPUS_MAPS = {
  office: buildCampus({
    ...
    ground: { color: 0x3f4348, roughness: 0.95 },
    ...
    buildings: [
      {
        ...
        rooms: [
          { id: "reception", name: "Reception", x: -16, z: 2, w: 28, d: 8, floor: 0x8791a1, breakers: { count: 2, w: 1.2, d: 2.4, h: 2.5, colors: [0x8791a1, 0x5a6473] }, scatter: { palette: PAL.recep, count: 19, dressing: { palette: DRESS.office, max: 3 } } },
          { id: "bullpen", name: "Bullpen", x: -16, z: -6, w: 28, d: 8, floor: 0x5b6470, breakers: { count: 3, w: 1.2, d: 2.4, h: 2.4, colors: [0x7d8899, 0x5f6a78] }, scatter: { palette: PAL.bullpen, count: 21, dressing: { palette: DRESS.office, max: 3 } } },
          { id: "offices", name: "Offices", x: -16, z: -14, w: 28, d: 8, floor: 0x6a7280, breakers: { count: 2, w: 1.2, d: 2.4, h: 2.5, colors: [0x5a3f2a, 0x8a9099] }, scatter: { palette: PAL.offices, count: 19, dressing: { palette: DRESS.office, max: 3 } } },
        ],
      },
      {
        ...
        rooms: [
          { id: "breakroom", name: "Break Room", x: 16, z: 2, w: 28, d: 8, floor: 0x9c8f79, breakers: { count: 2, w: 1.2, d: 2.2, h: 2.4, colors: [0x9c8f79, 0x566173] }, scatter: { palette: PAL.brk, count: 17, dressing: { palette: DRESS.office, max: 3 } } },
          { id: "copyit", name: "Copy / IT", x: 16, z: -6, w: 28, d: 8, floor: 0x5f6a78, breakers: { count: 3, w: 1.2, d: 2.4, h: 2.4, colors: [0x5f6a78, 0xc9b98a] }, scatter: { palette: PAL.offices, count: 19, dressing: { palette: DRESS.office, max: 3 } } },
          { id: "annexconf", name: "Conference", x: 16, z: -14, w: 28, d: 8, floor: 0x6a7280, breakers: { count: 2, w: 1.2, d: 2.2, h: 2.4, colors: [0x6a7280, 0xa8845c] }, scatter: { palette: PAL.brk, count: 14, dressing: { palette: DRESS.office, max: 3 } } },
        ],
      },
    ],
    zones: [
      { id: "lot", name: "Parking Lot", x: 0, z: 17, w: 64, d: 18, floor: 0x55555a, breakers: { count: 4, w: 1.6, d: 1.6, h: 2.8, colors: [0x6a7280, 0x55555a, 0x8a94a6] }, scatter: { palette: PAL.lot, count: 29, dressing: { palette: DRESS.yard, max: 3 }, margin: 2.5 } },
      { id: "breezeway", name: "Breezeway", x: 0, z: -5, w: 4, d: 26, floor: 0x606068 },
      { id: "alley", name: "Rear Alley", x: 0, z: -22, w: 64, d: 8, floor: 0x3d4048, breakers: { count: 3, w: 2.2, d: 2.2, h: 2.7, colors: [0x8a8a90, 0xb5622a] }, scatter: { palette: PAL.alley, count: 17, dressing: { palette: DRESS.yard, max: 3 }, margin: 2 } },
    ],
  ...
  street: buildCampus({
    ...
    seed: 0xbacc10,
    bounds: { minX: -32, maxX: 32, minZ: -26, maxZ: 26 }, wallHeight: 5,
    ground: { color: 0x4a4a50, roughness: 0.95 },
    ...
    buildings: [
      {
        ...
        rooms: [{ id: "grocer", name: "Grocer", x: -20, z: -16, w: 12, d: 16, floor: 0x8f897a, breakers: { count: 2, w: 1.2, d: 2.0, h: 2.4, colors: [0xc23b3b, 0x8f897a] }, scatter: { palette: PAL.grocer, count: 14, dressing: { palette: DRESS.retail, max: 3 } } }],
      },
      {
        id: "C", name: "Cafe", x: -20, z: 0, w: 12, d: 14, floor: 0x9c8f79,
        doors: [{ side: "E", at: 0, width: 3.2 }, { side: "W", at: 0, width: 2.6 }],
        rooms: [{ id: "cafe", name: "Cafe", x: -20, z: 0, w: 12, d: 14, floor: 0x9c8f79, breakers: { count: 2, w: 1.2, d: 2.0, h: 2.4, colors: [0x9c8f79, 0x7a4a5a] }, scatter: { palette: PAL.cafe, count: 13, dressing: { palette: DRESS.retail, max: 3 } } }],
      },
      {
        id: "H", name: "Hardware", x: -20, z: 16, w: 12, d: 14, floor: 0x6f6a62,
        doors: [{ side: "E", at: 0, width: 3.2 }, { side: "W", at: 0, width: 2.6 }],
        rooms: [{ id: "hardware", name: "Hardware", x: -20, z: 16, w: 12, d: 14, floor: 0x6f6a62, breakers: { count: 2, w: 1.2, d: 2.4, h: 2.6, colors: [0x8a9099, 0x3d5a7a] }, scatter: { palette: PAL.hardware, count: 14, dressing: { palette: DRESS.retail, max: 3 } } }],
      },
    ],
    zones: [
      { id: "alley", name: "Service Alley", x: -29, z: 0, w: 6, d: 52, floor: 0x3a3844 },
      { id: "mainst", name: "Main Street", x: -3, z: 0, w: 22, d: 52, floor: 0x50505a, breakers: { count: 4, w: 2.0, d: 2.0, h: 2.8, colors: [0x7a4636, 0xc23b3b, 0x5f9a3a] }, scatter: { palette: PAL.street, count: 24, dressing: { palette: DRESS.yard, max: 3 }, margin: 2.4 } },
      { id: "yard", name: "Loading Yard", x: 20, z: 0, w: 24, d: 52, floor: 0x5a5a62, breakers: { count: 4, w: 2.4, d: 2.4, h: 2.8, colors: [0xb5622a, 0x2f6a8a, 0x6b7a52] }, scatter: { palette: PAL.yard, count: 29, dressing: { palette: DRESS.yard, max: 3 }, margin: 2.6 } },
    ],
  ...
  supermarket: buildCampus({
    ...
    seed: 0x5ca7ed,
    bounds: { minX: -32, maxX: 32, minZ: -26, maxZ: 26 }, wallHeight: 5,
    ground: { color: 0x4a4e52, roughness: 0.95 },
    ...
    buildings: [
      {
        ...
        rooms: [
          { id: "vestibule", name: "Vestibule", x: -10, z: 7, w: 42, d: 6, floor: 0x8a8375, breakers: { count: 3, w: 1.2, d: 2.0, h: 2.4, colors: [0x8a8375, 0x2fa36b] }, scatter: { palette: PAL.produce, count: 9, dressing: { palette: DRESS.retail, max: 3 } } },
          { id: "aisles", name: "Aisles", x: -21, z: -4, w: 20, d: 16, floor: 0x8f8a7c, breakers: { count: 2, w: 1.2, d: 2.6, h: 2.6, colors: [0xb8523a, 0x3a6ea5] }, scatter: { palette: PAL.aisles, count: 13, dressing: { palette: DRESS.retail, max: 3 } } },
          { id: "produce", name: "Produce & Deli", x: 1, z: -4, w: 20, d: 16, floor: 0x6f8a5c, breakers: { count: 2, w: 1.2, d: 2.4, h: 2.5, colors: [0xc96b3a, 0x5f9a3a] }, scatter: { palette: PAL.produce, count: 14, dressing: { palette: DRESS.retail, max: 3 } } },
          { id: "stockroom", name: "Stockroom", x: -10, z: -15, w: 42, d: 6, floor: 0x55575a, breakers: { count: 3, w: 1.4, d: 2.2, h: 2.6, colors: [0x55575a, 0x7a828a] }, scatter: { palette: PAL.stock, count: 12, dressing: { palette: DRESS.retail, max: 3 } } },
        ],
      },
    ],
    zones: [
      { id: "parking", name: "Parking", x: -11, z: 18, w: 42, d: 16, floor: 0x55555a, breakers: { count: 4, w: 1.6, d: 1.6, h: 2.8, colors: [0xbfc4c9, 0x55555a] }, scatter: { palette: PAL.lot, count: 24, dressing: { palette: DRESS.yard, max: 3 }, margin: 2.6 } },
      { id: "dock", name: "Loading Yard", x: 21, z: 4, w: 21, d: 44, floor: 0x5a5a62, breakers: { count: 4, w: 2.4, d: 2.4, h: 2.8, colors: [0x6b7a52, 0xb5622a] }, scatter: { palette: PAL.yard, count: 21, dressing: { palette: DRESS.yard, max: 3 }, margin: 2.6 } },
      { id: "gardenctr", name: "Garden Centre", x: 21, z: -22, w: 21, d: 8, floor: 0x3f5a3a, scatter: { palette: PAL.garden, count: 9, dressing: { palette: DRESS.retail, max: 3 }, margin: 2 } },
    ],
