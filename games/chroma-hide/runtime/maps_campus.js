    ...
    buildings: [
      {
        ...
        rooms: [
          { id: "reception", name: "Reception", x: -28, z: 2, w: 16, d: 10, floor: 0x8a5a34, tex: "wood", breakers: { count: 2, w: 1.2, d: 2.4, h: 2.5, colors: [0x8791a1, 0x5a6473] }, scatter: { palette: PAL.recep, count: 16, dressing: { palette: DRESS.office, max: 3 } } },
          { id: "lounge", name: "Lounge", x: -12, z: 2, w: 16, d: 10, floor: 0x7a5230, tex: "wood", breakers: { count: 2, w: 1.2, d: 2.2, h: 2.4, colors: [0x9c8f79, 0x566173] }, scatter: { palette: PAL.recep, count: 15, dressing: { palette: DRESS.office, max: 3 } } },
          { id: "bullpenW", name: "Bullpen West", x: -28, z: -8, w: 16, d: 10, floor: 0x5b6470, tex: "carpet", breakers: { count: 2, w: 1.2, d: 2.4, h: 2.4, colors: [0x7d8899, 0x5f6a78] }, scatter: { palette: PAL.bullpen, count: 18, dressing: { palette: DRESS.office, max: 3 } } },
          { id: "bullpenE", name: "Bullpen East", x: -12, z: -8, w: 16, d: 10, floor: 0x59626e, tex: "carpet", breakers: { count: 2, w: 1.2, d: 2.4, h: 2.4, colors: [0x8a94a6, 0x5f6a78] }, scatter: { palette: PAL.bullpen, count: 18, dressing: { palette: DRESS.office, max: 3 } } },
          { id: "officeW", name: "Offices West", x: -28, z: -18, w: 16, d: 10, floor: 0x6a7280, tex: "carpet", breakers: { count: 2, w: 1.2, d: 2.4, h: 2.5, colors: [0x5a3f2a, 0x8a9099] }, scatter: { palette: PAL.offices, count: 16, dressing: { palette: DRESS.office, max: 3 } } },
          { id: "officeE", name: "Offices East", x: -12, z: -18, w: 16, d: 10, floor: 0x66707d, tex: "carpet", breakers: { count: 2, w: 1.2, d: 2.4, h: 2.5, colors: [0x8a9099, 0x5a6473] }, scatter: { palette: PAL.offices, count: 16, dressing: { palette: DRESS.office, max: 3 } } },
        ],
      },
      {
        ...
        rooms: [
          { id: "breakroom", name: "Break Room", x: 13, z: -0.5, w: 14, d: 15, floor: 0x9098a0, tex: "checker", breakers: { count: 2, w: 1.2, d: 2.2, h: 2.4, colors: [0x9c8f79, 0x566173] }, scatter: { palette: PAL.brk, count: 17, dressing: { palette: DRESS.office, max: 3 } } },
          { id: "meeting", name: "Meeting Room", x: 27, z: -0.5, w: 14, d: 15, floor: 0x7a5230, tex: "wood", breakers: { count: 2, w: 1.2, d: 2.2, h: 2.4, colors: [0x6a7280, 0xa8845c] }, scatter: { palette: PAL.brk, count: 15, dressing: { palette: DRESS.office, max: 3 } } },
          { id: "copyit", name: "Copy / IT", x: 13, z: -15.5, w: 14, d: 15, floor: 0x5f6a78, tex: "carpet", breakers: { count: 2, w: 1.2, d: 2.4, h: 2.4, colors: [0x5f6a78, 0xc9b98a] }, scatter: { palette: PAL.offices, count: 17, dressing: { palette: DRESS.office, max: 3 } } },
          { id: "server", name: "Server Room", x: 27, z: -15.5, w: 14, d: 15, floor: 0x4e565f, tex: "concrete", breakers: { count: 3, w: 1.2, d: 2.4, h: 2.6, colors: [0x3d5a7a, 0x7a828a] }, scatter: { palette: PAL.offices, count: 15, dressing: { palette: DRESS.office, max: 3 } } },
        ],
      },
    ],
    zones: [
    ...
    buildings: [
      {
        ...
        rooms: [
          { id: "grocer", name: "Grocer", x: -24, z: -21.5, w: 16, d: 10, floor: 0x8a6038, tex: "wood", breakers: { count: 2, w: 1.2, d: 2.2, h: 2.5, colors: [0xc23b3b, 0x8f897a] }, scatter: { palette: PAL.grocer, count: 15, dressing: { palette: DRESS.retail, max: 3 } } },
          { id: "grocer_back", name: "Grocer Store", x: -24, z: -29.0, w: 16, d: 5, floor: 0x6b5236, tex: "concrete", breakers: { count: 2, w: 1.2, d: 1.8, h: 2.5, colors: [0x7a828a, 0xb07a3a] }, scatter: { palette: PAL.stock, count: 9, margin: 1.6, dressing: { palette: DRESS.retail, max: 3 } } },
        ],
      },
      {
        ...
        rooms: [
          { id: "cafe", name: "Cafe", x: -24, z: -5.5, w: 16, d: 10, floor: 0x8f887c, tex: "checker", breakers: { count: 2, w: 1.2, d: 2.2, h: 2.5, colors: [0xc23b3b, 0x8f897a] }, scatter: { palette: PAL.cafe, count: 15, dressing: { palette: DRESS.retail, max: 3 } } },
          { id: "cafe_back", name: "Cafe Kitchen", x: -24, z: -13.0, w: 16, d: 5, floor: 0x6f6a62, tex: "concrete", breakers: { count: 2, w: 1.2, d: 1.8, h: 2.5, colors: [0x7a828a, 0xb07a3a] }, scatter: { palette: PAL.stock, count: 9, margin: 1.6, dressing: { palette: DRESS.retail, max: 3 } } },
        ],
      },
      {
        ...
        rooms: [
          { id: "hardware", name: "Hardware", x: -24, z: 10.5, w: 16, d: 10, floor: 0x6f6a62, tex: "concrete", breakers: { count: 2, w: 1.2, d: 2.2, h: 2.5, colors: [0xc23b3b, 0x8f897a] }, scatter: { palette: PAL.hardware, count: 15, dressing: { palette: DRESS.retail, max: 3 } } },
          { id: "hardware_back", name: "Hardware Back", x: -24, z: 3.0, w: 16, d: 5, floor: 0x5f5a54, tex: "concrete", breakers: { count: 2, w: 1.2, d: 1.8, h: 2.5, colors: [0x7a828a, 0xb07a3a] }, scatter: { palette: PAL.stock, count: 9, margin: 1.6, dressing: { palette: DRESS.retail, max: 3 } } },
        ],
      },
      {
        ...
        rooms: [
          { id: "laundry", name: "Laundry", x: -24, z: 26.5, w: 16, d: 10, floor: 0x8f8a80, tex: "checker", breakers: { count: 2, w: 1.2, d: 2.2, h: 2.5, colors: [0xc23b3b, 0x8f897a] }, scatter: { palette: PAL.cafe, count: 15, dressing: { palette: DRESS.retail, max: 3 } } },
          { id: "laundry_back", name: "Laundry Back", x: -24, z: 19.0, w: 16, d: 5, floor: 0x6a655e, tex: "concrete", breakers: { count: 2, w: 1.2, d: 1.8, h: 2.5, colors: [0x7a828a, 0xb07a3a] }, scatter: { palette: PAL.stock, count: 9, margin: 1.6, dressing: { palette: DRESS.retail, max: 3 } } },
        ],
      },
    ],
    zones: [
    ...
    buildings: [
      {
        ...
        rooms: [
          { id: "vestibule", name: "Vestibule", x: -23, z: 6, w: 22, d: 12, floor: 0x9aa0a6, tex: "checker", breakers: { count: 2, w: 1.2, d: 2.0, h: 2.4, colors: [0x8a8375, 0x2fa36b] }, scatter: { palette: PAL.produce, count: 16, dressing: { palette: DRESS.retail, max: 3 } } },
          { id: "aisles", name: "Aisles", x: -1, z: 6, w: 22, d: 12, floor: 0xa8aeb4, tex: "checker", breakers: { count: 3, w: 1.2, d: 2.6, h: 2.6, colors: [0xb8523a, 0x3a6ea5] }, scatter: { palette: PAL.aisles, count: 20, dressing: { palette: DRESS.retail, max: 3 } } },
          { id: "produce", name: "Produce & Deli", x: -23, z: -6, w: 22, d: 12, floor: 0x8fa07a, tex: "checker", breakers: { count: 2, w: 1.2, d: 2.4, h: 2.5, colors: [0xc96b3a, 0x5f9a3a] }, scatter: { palette: PAL.produce, count: 19, dressing: { palette: DRESS.retail, max: 3 } } },
          { id: "chilled", name: "Chilled", x: -1, z: -6, w: 22, d: 12, floor: 0x9fb0bc, tex: "checker", breakers: { count: 3, w: 1.2, d: 2.4, h: 2.6, colors: [0xbcd4e0, 0x46525a] }, scatter: { palette: PAL.produce, count: 18, dressing: { palette: DRESS.retail, max: 3 } } },
          { id: "stockroom", name: "Stockroom", x: -23, z: -18, w: 22, d: 12, floor: 0x55575a, tex: "concrete", breakers: { count: 3, w: 1.4, d: 2.2, h: 2.6, colors: [0x55575a, 0x7a828a] }, scatter: { palette: PAL.stock, count: 19, dressing: { palette: DRESS.retail, max: 3 } } },
          { id: "backdock", name: "Back Dock", x: -1, z: -18, w: 22, d: 12, floor: 0x5d6064, tex: "concrete", breakers: { count: 3, w: 1.4, d: 2.2, h: 2.6, colors: [0x6b7a52, 0xb5622a] }, scatter: { palette: PAL.stock, count: 17, dressing: { palette: DRESS.retail, max: 3 } } },
        ],
      },
    ],
    zones: [
