...
export default {
  ...
  objects: [
    ...
    { kind: 'deco', kindOf: 'crystals', solid: true, p: [262.9, 16.0, 0], count: 12, spread: 6.0, scale: 2.4, seed: 4001, mat: 'crystal' },
    { kind: 'deco', kindOf: 'crystals', solid: true, p: [289.7, 17.0, 0], count: 12, spread: 6.0, scale: 2.4, seed: 4002, mat: 'crystal' },
